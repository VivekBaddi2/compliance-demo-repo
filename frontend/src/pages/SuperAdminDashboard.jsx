  ...
  const { value: formValues } = await Swal.fire({
    ...
    preConfirm: () => {
      return {
        ...
        udhyamAdhaarCategory: document.getElementById("swal-udhyamAdhaarCategory").value,
            ...
            <tr key={admin._id} className="hover:bg-gray-50">
              ...
              <td className="border px-4 py-2">
                {admin.assignedCompanies?.length > 0
                  ? admin.assignedCompanies.map((c) => c.clientName).join(", ")
                  : "None"}
              </td>
  ...
  <div className="bg-white p-6 rounded-xl shadow">
    ...
    <div className="flex flex-wrap gap-4 mb-4">
      ...
      <input
        ...
        onChange={(e) =>
          setNewCompany({ ...newCompany, dateOfIncorporation: e.target.value })
        }
        className="px-4 py-2 border rounded-lg flex-1 min-w-[200px]"
      />
      <input
      ...
      <input
        ...
        onChange={(e) =>
          setNewCompany({ ...newCompany, udhyamAdhaarCategory: e.target.value })
        }
        className="px-4 py-2 border rounded-lg flex-1 min-w-[200px]"
      />
      <input
        ...
        placeholder="PF"
        value={newCompany.pf || ""}
        onChange={(e) => setNewCompany({ ...newCompany, pf: e.target.value })}
        className="px-4 py-2 border rounded-lg flex-1 min-w-[200px]"
      />
      <input
        type="text"
        ...
        onChange={(e) => setNewCompany({ ...newCompany, esi: e.target.value })}
        className="px-4 py-2 border rounded-lg flex-1 min-w-[200px]"
      />
      <input
        type="text"
...
{activeTab === "allotments" && (
  <div className="bg-gray-50 p-6 rounded-xl shadow">
    ...
    <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-h-64 overflow-y-auto">
        {admins.map((a) => (
          ...
          >
            <h4 className="font-semibold text-blue-800 mb-2">{a.username}</h4>
                ...
                a.assignedCompanies.map((c) => (
                  <div key={c._id} className="relative inline-block">
                    <span className="bg-blue-200 text-blue-800 px-2 py-1 rounded-full text-sm inline-flex items-center gap-1">
                      {c.clientName}
                      <button
                        onClick={() => handleRemoveAllotment(a._id, c._id)}
    ...
    <div className="bg-white p-4 rounded-lg shadow-sm mb-6 border border-gray-200">
      <h3 className="text-xl font-semibold mb-4">Assign Companies to Admin</h3>
      <div className="flex flex-wrap gap-6 items-end">
        <div className="flex flex-col gap-2 flex-1 min-w-[200px]">
          <label className="font-semibold text-gray-700">Select Admin</label>
          <select
            value={selectedAdmin}
        ...
        <div className="flex flex-col gap-2 flex-1 min-w-[200px]">
          <label className="font-semibold text-gray-700">Select Companies</label>
          <select
            multiple
    ...
    <div className="bg-white p-4 rounded-lg shadow-sm mb-6 border border-gray-200">
      ...
      <div className="flex flex-wrap gap-6 items-end">
        <div className="flex flex-col gap-2 flex-1 min-w-[200px]">
          <label className="font-semibold text-gray-700">From Admin</label>
          <select
            value={fromAdmin}
        ...
        <div className="flex flex-col gap-2 flex-1 min-w-[200px]">
          <label className="font-semibold text-gray-700">Companies to Re-allot</label>
          <select
            multiple
